...
<head>
    ...
    <title>Md Alif Khan Rifat</title>
</head>
...
<body>
    ...
    <header class="l-header">
        <nav class="nav bd-grid">
            <div>
                <a href="#" class="nav__logo">MD. ALIF KHAN RIFAT</a>
            </div>
        ...
        <section class="skills section" id="skills">
            ...
            <div class="skills__container bd-grid">
                <div>
                    ...
                    <div class="skills__data">
                        <span class="skills__name">Front End : HTML, CSS, Bootstrap</span>
                    </div>
                    <div class="skills__data">
                        <span class="skills__name">Database : SQL(Mysql,SqLite)</span>
                    </div>
                    <div class="skills__data">
                        <span class="skills__name">Web Server : Apache, Nginx</span>
                    </div>
                    <div class="skills__data">
                        <span class="skills__name">Coding Concept : OOP, MVC,Structural </span>
                    </div>
                    <div class="skills__data">
                        <span class="skills__name">Version Control : Git</span>
                    </div>
                </div>
    ...
    <!--===== FOOTER =====-->
    <footer class="footer">
        <p class="footer__title">Md Alif Khan Rifat</p>
